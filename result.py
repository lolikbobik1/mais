...
# стіни
w1 = Wall(46, 0, 0, 100, 20, 450, 10)
w2 = Wall(46, 0, 0, 300, 220, 75, 10)
w3 = Wall(46, 0, 0, 100, 120, 10, 380)
w4 = Wall(46, 0, 0, 200, 20, 10, 380)
w5 = Wall(46, 0, 0, 450, 130, 10, 360)
w6 = Wall(46, 0, 0, 300, 100, 10, 350)
w7 = Wall(46, 0, 0, 390, 120, 130, 10)
wall_list=[w1,w2,w3,w4,w5,w6,w7]
game = True
finish = False
clock = time.Clock()
FPS = 60
...
win = font.render('Ти ботик, але виграв!', True, (255, 215, 0))
lose = font.render('Ти ботік!', True, (180, 0, 0))
restart=font.render('Ти ботік тому клікай "R"', True, (180,10,30))
# музика
mixer.init()
